...
const AboutUs: React.FC = () => {
    useSEO({
        title: "About Us - InfinityGrab | Free Video Downloader",
        description: "Learn about InfinityGrab, our mission, and what makes us the best free online video downloader for YouTube, Facebook, TikTok, Instagram & more.",
        keywords: "About InfinityGrab, free video downloader tool, download youtube video mission, Infinity Grab story",
        canonical: "https://infinitygrab.xyz/about"
    });
